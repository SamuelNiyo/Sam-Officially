...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2024 at 04:14 PM
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `tin_number`, `date_of_birth`, `address`, `email`, `registration_date`, `agent_id`) VALUES
(23, 'samm', 'niiiii', 1234567890, '0000-00-00', 'sdfghj', 'sdfghjk', '2022-12-11', 65);
...
('asdfg', 'erftgh', 'sam@gmail.com', '12345', '$2y$10$4ND47h86G1MdgwD4yyZDaelCYchB442lvuAOBZOUPQnw5Lj/IsI1O', 123456789, 123),
('sam', 'hajji', 'habari@bit.com', 'sammy', '$2y$10$UyStplFtMGfYa3cc1LJFf.zM.Pt1dXcZPEJkxtYZBEmDJA9HBNauW', 788201441, 1),
('bh', 'jj', 'mpamire@gmail.com', 'sniyomurengezi', '$2y$10$MmSpOSeV1oXqnYHU8PeE6eKYn74RWiGCbXF3QAXEJ91kACpKjHA.e', 788201441, 12345);
